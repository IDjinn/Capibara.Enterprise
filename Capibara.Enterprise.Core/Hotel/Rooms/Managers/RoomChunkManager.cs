...
public sealed class RoomChunkManager : IRoomChunkManager
{
    private readonly ConcurrentDictionary<ChunkId, IChunk> _chunks;
    private readonly ILogger<RoomChunkManager> _logger;

    public RoomChunkManager(ILogger<RoomChunkManager> logger)
    {
        _logger = logger;
